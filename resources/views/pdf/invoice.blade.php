  ...
  <div class="invoice-box">
    ...
    <table class="header-table">
      <tr>
        <td>
          ...
          <div class="brand-subtitle">Living art, cultivated with patience</div>
        </td>
    ...
    <table class="totals-table">
      <tr>
        ...
        <td class="text-right" style="width: 120px;">Rp {{ number_format($subtotal, 0, ',', '.') }}</td>
      </tr>
      <tr>
        <td></td>
        <td class="total-label">Shipping:</td>
        <td class="text-right" style="color: #2D3E2F; font-weight: 500;">FREE</td>
      </tr>
      <tr>
        <td></td>
        <td class="total-label" style="font-weight: 600; font-size: 15px; color: #2D3E2F; padding-top: 10px;">Total:</td>
        <td class="total-amount" style="padding-top: 10px;">Rp {{ number_format($subtotal, 0, ',', '.') }}</td>
      </tr>
    </table>

    <!-- Stempel / Note -->
    <div class="footer">
      <p>Thank you for cultivating mindfulness through our living art.</p>
      <p>&copy; {{ date('Y') }} bonsaiku. All rights reserved.</p>
    </div>
