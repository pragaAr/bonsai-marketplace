...
<body 
  class="bg-cream text-primary font-sans antialiased"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        ...
        <nav class="hidden md:flex items-center gap-8" aria-label="Main navigation">
          ...
          <a 
            href="/care-guide" 
            wire:navigate class="text-sm font-medium transition-colors hover:text-accent {{ request()->is('care-guide*') ? 'text-accent' : 'text-primary' }}">
            Panduan
          </a>
          <a 
            href="/article" 
        ...
        <div class="flex items-center gap-2">
          ...
          @auth
            <div 
              x-data="{ open: false, avatarUrl: '{{ e(auth()->user()->avatar) }}' }" 
    ...
    <nav 
          ...
          @auth
            <div 
              ...
              <div class="flex items-center gap-3 mb-4">
                ...
                <div>
                  <p class="text-sm font-semibold text-primary truncate max-w-[200px]">
                    {{ auth()->user()->name }}
                  </p>
                  <p class="text-xs text-primary/60 truncate max-w-[200px]">
                    {{ auth()->user()->email }}
                  </p>
                </div>
              </div>
              ...
              <div class="space-y-1">
                ...
                <a 
                  href="{{ route('profile') }}" 
                  wire:navigate class="block py-2 text-base font-medium text-primary hover:text-accent transition-colors">
                  Profil Saya
                </a>
              </div>
      ...
      <div class="border-t border-primary/10 p-6 bg-cream">
        <p class="text-xs text-primary/40 text-center">
          &copy; {{ date('Y') }} 
          bonsaiku. Keindahan yang Tumbuh, Nilai yang Bertahan.
        </p>
      </div>
    </nav>
  </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <nav class="flex flex-col gap-2.5" aria-label="Footer navigation">
            <a 
              href="/about" wire:navigate 
              class="text-sm hover:text-cream transition-colors">
              Tentang
            </a>
            <a 
              href="/shop" wire:navigate 
              class="text-sm hover:text-cream transition-colors">
              Koleksi
            </a>
            <a 
              href="/care-guide" wire:navigate 
              class="text-sm hover:text-cream transition-colors">
              Panduan
            </a>
            <a 
              href="/article" wire:navigate 
              class="text-sm hover:text-cream transition-colors">
              Artikel
            </a>
          </nav>
        ...
        <div>
          ...
          <div class="flex flex-col gap-3">
            ...
            <a 
              href="/shop?category=pot-bonsai" 
              wire:navigate 
              class="text-sm hover:text-cream transition-colors">
              Pot Bonsai
            </a>
            <a 
              href="/shop?category=peralatan" 
              wire:navigate 
              class="text-sm hover:text-cream transition-colors">
              Peralatan
            </a>
          ...
          <div class="flex flex-col gap-3">
            <a 
              ...
              <svg 
                ...
                <path d="M12 0C5.373 0 0 5.373 0 12c0 2.12.553 4.11 1.519 5.838L0 24l6.335-1.652A11.94 11.94 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.82a9.78 9.78 0 01-5.283-1.545l-.379-.226-3.93 1.025 1.05-3.83-.248-.394A9.78 9.78 0 012.18 12c0-5.422 4.398-9.82 9.82-9.82s9.82 4.398 9.82 9.82-4.398 9.82-9.82 9.82z"/>
              </svg>
              WhatsApp
            </a>
            <a 
