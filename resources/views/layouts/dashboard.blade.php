...
<body
  ...
  <div class="flex h-screen overflow-hidden">
    <!-- Sidebar -->
    <aside 
      :class="sidebarOpen ? 'translate-x-0 md:flex' : '-translate-x-full md:hidden'" 
    ...
    <div class="flex-1 flex flex-col overflow-y-auto">
      ...
      <header class="flex h-14 flex-shrink-0 items-center justify-between bg-cream/95 backdrop-blur-sm px-4 border-b border-primary/10">
          ...
          <button 
            ...
            class="inline-flex p-2 rounded hover:bg-primary/5">
              <svg 
                ...
                <path 
                  fill-rule="evenodd" 
                  d="M6 4a1 1 0 000 2h8a1 1 0 100-2H6zm-2 5a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zm1 4a1 1 0 000 2h8a1 1 0 100-2H6z" clip-rule="evenodd"/>
              </svg>
          </button>
          <h1 
            x-show="!sidebarOpen" 
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="relative">
            ...
            <div 
              ...
              class="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-primary/10 z-50" style="display: none;">
              @auth
