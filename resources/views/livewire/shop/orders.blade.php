  ...
  <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
    <div
      ...
      <h1
        ...
        History Pembelian</h1>
      <p
        class="mt-4 max-w-2xl text-sm leading-6 text-primary/70 sm:text-base">
        Halaman ini disiapkan untuk riwayat pesanan. Saat
        persistence order sudah aktif, daftar transaksi dan
        detailnya akan muncul di sini.
      </p>

      <div
        class="mt-8 rounded-3xl border border-dashed border-primary/15 bg-cream p-6 sm:p-8">
        <h2 class="text-lg font-semibold text-primary">Belum
          ada data order</h2>
        <p
          class="mt-2 max-w-2xl text-sm leading-6 text-primary/65">
          Checkout saat ini masih berjalan sebagai mock,
          jadi history pembelian belum bisa diisi dari
          database.
        </p>
