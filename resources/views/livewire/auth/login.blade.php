    ...
    <div class="glass rounded p-8 shadow-xl">
      ...
      <form wire:submit="login" class="space-y-5"
            ...
            <div class="relative">
              ...
              <button type="button"
                ...
                <svg x-show="showPassword"
                  style="display: none;" class="h-5 w-5"
                  fill="none" viewBox="0 0 24 24"
                  stroke-width="1" stroke="currentColor">
                  <path stroke-linecap="round"
                    stroke-linejoin="round"
        ...
        <div class="flex items-center justify-between mb-4">
          <label class="inline-flex items-center">
            ...
            <span class="ml-2 text-sm text-primary">Ingat
              saya</span>
          </label>
          <a href="#"
            class="text-sm text-primary hover:underline">Lupa
            password?</a>
        </div>
        <button type="submit"
      ...
      <div class="relative my-5">
        ...
        <div class="relative flex justify-center text-xs">
          <span
            class="bg-white/60 px-3 text-primary/50 font-medium uppercase tracking-wider">atau</span>
        </div>
      </div>
