        ...
        <section
          ...
          <div class="mt-8 flex flex-wrap gap-3">
            <button type="button" wire:click="openEditor"
              ...
              class="inline-flex items-center gap-2 justify-center rounded-full border border-primary/15 bg-white px-5 py-3 text-sm font-semibold text-primary transition-colors hover:bg-primary/5 disabled:opacity-50 cursor-pointer">
              ...
              @else
                <a href="{{ route('seller.apply') }}"
                  ...
                  :class="loading ?
                      ...
                      ''"
                  class="inline-flex items-center justify-center gap-2 rounded-full bg-cream px-5 py-3 text-sm font-semibold text-primary transition-colors hover:bg-cream/90 cursor-pointer">
