    ...
    <div x-show="show" x-trap="show"
      ...
      <form wire:submit="saveAccess"
        ...
        <div>
          ...
          <div x-data="tomSelect({ lazy: true, show: @entangle('showManageModal'), value: @entangle('selectedRole'), placeholder: 'Pilih Role', ref: 'selectManageRole', dropdownParent: 'body' })" wire:ignore
      ...
      <form wire:submit="save"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <div x-data="tomSelect({ lazy: true, value: @entangle('createRole'), show: @entangle('showCreateModal'), placeholder: 'Pilih Role', ref: 'selectCreateRoleModal', dropdownParent: 'body' })" wire:ignore
              class="w-full rounded-xl">
    ...
    <div x-show="show" x-trap="show"
      ...
      <form wire:submit="filterList"
        ...
        <div>
          ...
          <div x-data="tomSelect({ lazy: true, show: @entangle('showFilterModal'), value: '{{ $filterRole }}', placeholder: 'Pilih Role', ref: 'selectFilterRole', dropdownParent: 'body' })" wire:ignore
            class="w-full"
