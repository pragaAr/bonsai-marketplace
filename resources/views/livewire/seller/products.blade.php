<div class="space-y-6">
  ...
  <div
    ...
    <div>
      <h1 class="text-2xl font-bold text-primary">Daftar
        Produk Saya</h1>
      <p class="text-sm text-primary/60 mt-1">Kelola dan
        pantau semua produk yang Anda pasarkan</p>
    </div>
    <div>
              ...
              <td class="px-6 py-4 text-right">
                <div
                  ...
                  <a href="{{ route('seller.products.edit', $product->id) }}"
                    wire:navigate
                    class="p-1 text-primary/60 hover:text-accent transition duration-150"
                    title="Edit Produk">
                    <svg xmlns="http://www.w3.org/2000/svg"
                  ...
                  <button
                    ...
                    class="p-1 text-primary/60 hover:text-red-600 transition duration-150"
                    title="Hapus Produk">
                    <svg xmlns="http://www.w3.org/2000/svg"
                      class="h-5 w-5" fill="none"
                      viewBox="0 0 24 24"
  ...
  @if ($showDeleteModal)
    <div
      ...
      <div
        ...
        <div
          class="bg-white rounded-xl shadow-xl border border-primary/10 overflow-hidden">
          <div class="p-6">
            <div
              class="flex items-center justify-center w-12 h-12 mx-auto bg-red-100 rounded-full text-red-600 mb-4">
              <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <h3
              class="text-lg font-bold text-center text-primary mb-2">
              Hapus Produk?</h3>
            <p
              class="text-sm text-center text-primary/70 mb-6">
              Apakah Anda yakin ingin menghapus produk ini?
              Tindakan ini tidak dapat dibatalkan dan semua
              data produk serta gambar akan dihapus
              permanen.
            </p>
