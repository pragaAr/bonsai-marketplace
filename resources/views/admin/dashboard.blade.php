...
@section('title', 'Admin Dashboard – bonsaiku')
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        {{-- Total Products --}}
        <div class="bg-white rounded-xl shadow-sm border border-primary/10 p-5 hover:shadow-md transition-shadow">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-primary/10">
        <div class="p-5 border-b border-primary/10">
            <h2 class="text-lg font-semibold text-primary">Produk Terbaru</h2>
        </div>
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                <thead class="bg-primary/5">
                    <tr>
                        <th class="px-5 py-3 text-left text-xs font-medium text-primary/70 uppercase">Nama</th>
                        <th class="px-5 py-3 text-left text-xs font-medium text-primary/70 uppercase">Kategori</th>
                        <th class="px-5 py-3 text-left text-xs font-medium text-primary/70 uppercase">Harga</th>
                        <th class="px-5 py-3 text-left text-xs font-medium text-primary/70 uppercase">Status</th>
                        <th class="px-5 py-3 text-left text-xs font-medium text-primary/70 uppercase">Tanggal</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-primary/10">
                    ...
                    @empty
                    <tr>
                        <td colspan="5" class="px-5 py-8 text-center text-primary/50">Belum ada produk</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
